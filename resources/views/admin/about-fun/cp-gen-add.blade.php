...
@section('title')
Consultant Surgeon General Add
@endsection
        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title"> Consultant Surgeon General Add</h1>
                    </div>
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Consultant Surgeon General</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Consultant Surgeon General Add</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h3 class="card-title">Consultant Surgeon General Add</h3>
                            </div>
                            <div class="card-body">
                                
                                <p class="text-success">{{ session('message') }}</p>
                                <form class="needs-validation" method="POST" action="{{ route('cs-gen-store') }}" >
                                    @csrf
                                    <div class="form-row">
